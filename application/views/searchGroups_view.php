...
function displayTiles($groups){
	...
	for ($x = $index; $x < $max; $x++) {
		...
		echo "<a id='".$groups[$x]['org_id']."' href='".base_url()."/Group/display/".$groups[$x]['org_id']."'><img class='img-responsive' src='";
		...
		<a class='btn btn-primary waves-effect waves-light' href='".base_url()."/Group/display/".$groups[$x]['org_id']."'>See More</a>
