...
<header id="first">
    <div class="header-content">
        <div class="inner">
            <h1 class="cursive">Welcome to Campfire <img id="transparentLogo" src="http://teamcampfire.me/assets/img/ionicons_bonfire.png"></h1>
            <h4>Connect with others by simply searching for events or groups</h4>
            <hr>
            <a id = 'search_events' href="http://teamcampfire.me/event/search" class="btn btn-primary btn-xl">Search Events</a> &nbsp;
            <a id = 'search_groups' href="http://teamcampfire.me/group/search" class="btn btn-primary btn-xl">Search Groups</a>
        </div>
    </div>
    <video autoplay="" loop="" class="fillWidth fadeIn wow collapse in" data-wow-delay="0.5s" poster="http://teamcampfire.me/assets/img/Campfire.png" id="video-background">
        <source src="http://teamcampfire.me/assets/video/Campfire.mp4" type="video/mp4">Your browser does not support the video tag. I suggest you upgrade your browser.
    </video>
</header>
...
<div class="container">
	<div class="row">
		<div class="col-md-4 wow fadeInLeft">
			...
			<img src="http://teamcampfire.me/assets/img/devteam.JPG" class="img-rounded"  width="304" height="236">
		</div>
		<div class="col-md-8">
